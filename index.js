...
// 	// 	console.log(finalpath[(i).toString()]["routes"]["0"]["overview_path"][0])
...
// 	// 	console.log(finalpath[(i).toString()])
...
// 	const path2 = finalpath["Keble"]["Jesus"]["routes"][0]["legs"][0]["steps"]
// 	console.log(path2);
...
// 		var marker = new google.maps.Marker({
// 			position: {
// 				"lat": path2[i]["startLocation"]["latLng"]["latitude"],
// 				"lng": path2[i]["startLocation"]["latLng"]["longitude"],
// 			},
// 			icon: waypointMarker,
// 			title:"Hello World!",
// 			label: {
...
// 		console.log(i)
// 		console.log(finalpath["Keble"]["Jesus"])

// 		directionsRenderer.setDirections(finalpath["Keble"]["Jesus"]);
// 		directionsRenderer.setOptions({ suppressMarkers: true })
